 ...
 * @author lenovo
 */
public class UserTaskSearchFrame extends javax.swing.JFrame {
	public JTable jTable1;
	public TaskSearchTableController taskSearchTableController;
	public UserTaskSearchFrame me;

	/**
	 * Creates new form MainFrame
	 */
	public UserTaskSearchFrame() {
	...
	private void initComponents() {
		...
		jTable1.setModel(new javax.swing.table.DefaultTableModel(
				new Object[][] { { null, null, null, null },
						...
						"Project Name", "Start Date", "End Date", "Task" }));
	...
	private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_submitButtonActionPerformed
		...
		taskSearchTableController = new TaskSearchTableController(this,
				inputProjectName, inputProjectId);

		jTable1.setModel(taskSearchTableController.getTableModel());
	...
	public void runTaSF() {
		...
		try {
			...
			java.util.logging.Logger.getLogger(
					UserTaskSearchFrame.class.getName()).log(
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new UserTaskSearchFrame().setVisible(true);
			}
		});
	}
