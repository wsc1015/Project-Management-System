 ...
 * @author lenovo
 */
public class UserTeamSearchFrame extends javax.swing.JFrame {
	public JTable jTable1;
	public TeamSearchTableController teamSearchTableController;
	UserTeamSearchFrame me;

	/**
	 * Creates new form MainFrame
	 */
	public UserTeamSearchFrame() {
	...
	private void initComponents() {
		...
		jTable1.setModel(new javax.swing.table.DefaultTableModel(
				new Object[][] { { null, null, null, null, null },
						...
						"Project Name", "Member Name", "Member Type",
						"Member Phone Number", "Mumber Email" }));
	...
	private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_submitButtonActionPerformed
		...
		String inputUserName = userNameTextField2.getText();
		int inputUserId = -1;
		if (userIDTextField1.getText().equals("") == false)
			inputUserId = Integer.valueOf(userIDTextField1.getText());
		teamSearchTableController = new TeamSearchTableController(this,
				inputProjectName, inputProjectId, inputUserName, inputUserId);

		jTable1.setModel(teamSearchTableController.getTableModel());
	...
	public void runTSF() {
		...
		try {
			...
			java.util.logging.Logger.getLogger(
					UserTeamSearchFrame.class.getName()).log(
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new UserTeamSearchFrame().setVisible(true);
			}
		});
	}
