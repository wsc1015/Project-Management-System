 ...
 * @author lenovo
 */
public class TimelineEdtFrame extends javax.swing.JFrame {
	private JTable jTable1;
	private TimeLineTableController timelineTableController;
    /**
     * Creates new form MainFrame
     */
    public TimelineEdtFrame() {
    	timelineTableController = new TimeLineTableController(this);
        initComponents();
        addJTable();
    }
    ...
    public void updateTable() {
		jTable1.setModel(timelineTableController.getTableModel());
	}

	// display data on the courseNameTextField
	public void setTimelineIdTextField(String value) {
		timelineIDTextField.setText(value);
	}
	...
	public void setTaskTextField(String value) {
		taskTestArea.setText(value);
	}
    ...
    private void initComponents() {
        ...
        timelineIDTextField = new javax.swing.JTextPane();
        ...
        taskTestArea = new javax.swing.JTextArea();
        ...
        jLabel5.setText("TimeLine Management");
        ...
        jScrollPane7.setViewportView(timelineIDTextField);
        ...
        taskTestArea.setColumns(20);
        taskTestArea.setRows(5);
        jScrollPane2.setViewportView(taskTestArea);
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
		...
		timelineTableController.addRow(array);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        // TODO add your handling code here:
    	int row = jTable1.getSelectedRow();
		timelineTableController.deleteRow(String.valueOf(row));
    ...
    public void runTimeline() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TimelineEdtFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TimelineEdtFrame().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextArea taskTestArea;
    private javax.swing.JButton teamManagementButton;
    private javax.swing.JTextField startDateTextField;
    private javax.swing.JTextField endDateTextField;
    private javax.swing.JTextPane timelineIDTextField;
