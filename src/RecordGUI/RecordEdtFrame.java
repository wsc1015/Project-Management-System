/*
 * To change this license header, choose License Headers in Record Properties.
...
public class RecordEdtFrame extends javax.swing.JFrame {
    ...
    public void updateTable() {
		jTable1.setModel(recordTableController.getTableModel());
	}

	// display data on the courseNameTextField
	public void setRecordIdTextField(String value) {
		recordIDTextField.setText(value);
	}
	...
	public void setTimeTextField(String value) {
		timeTextField.setText(value);
	}
	
	public void setContentTextField(String value) {
    ...
    private void initComponents() {
        ...
        recordIDTextField = new javax.swing.JTextPane();
        ...
        buttonManagementButton.setText("Record Management");
        ...
        jLabel5.setText("Record Management");
        ...
        jScrollPane7.setViewportView(recordIDTextField);
        ...
        jScrollPane8.setViewportView(contentTextArea);

        jLabel7.setText("Project ID：");

        jScrollPane2.setViewportView(RecordIDTextField);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
		...
		recordTableController.deleteRow(String.valueOf(row));
    }//GEN-LAST:event_deleteButtonActionPerformed

    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        // TODO add your handling code here:
    	String[] array = new String[jTable1.getColumnCount()];
		array[0] = recordIDTextField.getText();
		array[1] = userIDTextField.getText();
		array[2] = RecordIDTextField.getText();
		array[3] = timeTextField.getText();
		array[4] = contentTextArea.getText();
		recordTableController.addRow(array);
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
		...
		int row = jTable1.getSelectedRow();
		recordTableController.updateRow(String.valueOf(row), array);
    ...
    public void runRecord() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecordEdtFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RecordEdtFrame().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextPane RecordIDTextField;
